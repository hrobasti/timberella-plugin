...
| bStats Metrics (embedded class) | 3.2.1 | MIT License | <https://github.com/Bastian/bStats-Metrics> | `Metrics.java` relocated into `com.github.hrobasti.timberella.metrics` for telemetry. |
